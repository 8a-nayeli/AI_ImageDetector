	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "Modificar":
			...
			if (auxString.equals("2")) {// Quiere decir que si tengo que mandar correo
				...
				String titulo = "CAMBIO DE PRIVILEGIOS PCM QA";
				String cuerpo = "Buen día, <br>"
						+ " Tus privilegios para el portal: http://10.1.0.40:1010/PCM_QA/ han sido modificados: <br>"
			...
			if (conexion.getInstance().setup() != -1) {
				if (u != null) {
					...
					if (aux) {
						...
						String titulo = "CAMBIO DE CONTRASEÑA PCM QA";
						String cuerpo = "Buen día, <br>"
								+ " Tus nuevas credenciales para el  portal: http://10.1.0.40:1010/PCM_QA/ son las siguientes: <br>"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "restablecerPass":
			...
			String cuerpo = "<div class='d-flex justify-content-center' style='height:100%;margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;font-size:24px;line-height:167%;background-color:#efeeee;padding-left:75px;padding-right:75px;padding-top:45px;padding-bottom:0px'>"
					...
					+ " <a class='reset_pass 'href='http://10.1.0.40:1010/PCM_QA//usuario?op=Token&aux=" + tokenMD5
		...
		case "AJAX":
			...
			if (obju != null) {
				...
				titulo = "CAMBIO DE CONTRASEÑA PCM QA";
				cuerpo = "Buen día, <br>"
						+ " Tus nuevas credenciales para el  portal:http://10.1.0.40:1010/PCM_QA/ son las siguientes: <br>"
		...
		case "REGISTRO":
			...
			// no encontro correo registrado, puede agregar
			{
				...
				titulo = "CREDENCIALES DE ACCESO PCM QA";
				cuerpo = "Buen día, <br>"
						+ " Tus credenciales para el  portal: http://10.1.0.40:1010/PCM_QA/  son las siguientes: <br>"
