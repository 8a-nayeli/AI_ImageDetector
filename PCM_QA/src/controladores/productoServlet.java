									...
									for (int j = 0; j < imagen.length; j++) {
										...
										try {
											File fileImagen = new File(
													"E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\ImagenesBD\\"
															+ auxImg);
...
//						String ruta = "E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\ImagenesBD\\"
//								+ auxImg;
...
//			break;
		case "cargaMasivaMaterial":// CSV info del material
			...
			try {
				...
				File file = new File("E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_m.csv");
		...
		case "cargaMasivaMaterialPlataforma":// CSV carga masiva de materiales a plataformas
			...
			try {
				...
				InputStream is = csv.getInputStream();
				File file = new File(
						"E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_mp.csv");
				Files.copy(is, file.toPath(), StandardCopyOption.REPLACE_EXISTING);
		...
		case "bajaMaterialPlataforma":// CSV carga masiva de materiales a plataformas
			...
			try {
				...
				InputStream is = csv.getInputStream();
				File file = new File(
						"E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_mpb.csv");
				Files.copy(is, file.toPath(), StandardCopyOption.REPLACE_EXISTING);
		...
		case "cargaMasivaDC":// CSV descripcion comercial
			try {
				...
				File file = new File(
						"E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_dc.csv");
				Files.copy(is, file.toPath(), StandardCopyOption.REPLACE_EXISTING);
		...
		case "cargaMasiva":// CSV atributos
			try {
				...
				InputStream is = csv.getInputStream();
				File file = new File(
						"E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv.csv");
				Files.copy(is, file.toPath(), StandardCopyOption.REPLACE_EXISTING);
			} catch (Exception e) {
				e.printStackTrace();
			}
...
//						gramaje=gramaje.substring(0, gramaje.length()-1);
		...
		case "ConnectCargaMasivaMateriales":
			...
			try {
				...
				String ruta_csv = "E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_m.csv";
			...
			System.out.println("Entre a java, connect");
			 usuario = u.getIdUsuario();
						try {
							...
							String ruta_csv = "E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_mp.csv";
							String[] cmd = new String[] { "E:\\python\\Python39\\python.exe", ruta_py, ruta_csv, usuario };
							process = Runtime.getRuntime().exec(cmd);
			//Lee el error generado en python
						BufferedReader in = new BufferedReader( new InputStreamReader(this.process.getInputStream()));
		...
		case "ConnectMaterialesBaja"://ejecuta el codigo phyton
			 usuario = u.getIdUsuario();
						try {
							...
							String ruta_csv = "E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_mpb.csv";
							String[] cmd = new String[] { "E:\\python\\Python39\\python.exe", ruta_py, ruta_csv, usuario };
							process = Runtime.getRuntime().exec(cmd);
			//Lee el error generado en python
						BufferedReader in = new BufferedReader( new InputStreamReader(this.process.getInputStream()));
		...
		case "ConnectCargaMasivaDC":
			...
			try {				
				...
				String ruta_csv = "E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\cache_csv\\cache_csv_dc.csv";
				String[] cmd = new String[] {"E:\\python\\Python39\\python.exe", ruta_py, ruta_csv, usuario };
				process = Runtime.getRuntime().exec(cmd);
				///---	para leer el error
				BufferedReader in = new BufferedReader( new InputStreamReader(this.process.getInputStream()));
...
//						pdao.eliminar_imagen(auxImg);
//						// Eliminar la imagen de la carpeta
////						 ruta = "E:\\apache-tomcat-7.0.109\\webapps\\PCM_QA\\ImagenesBD\\"
////								+ auxImg;
////						File imagen = new File(ruta);
////						FileInputStream readImage = new FileInputStream(imagen);
////						readImage.close();
