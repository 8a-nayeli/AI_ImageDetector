					...
					<div id="mCSB_1_container"
						...
						<div class="left_col scroll-view">
							<div class="navbar nav_title" style="border: 0;">
								<a href="/PCM/Comunes/Index.jsp" class="site_title"><i
										...
										<c:if
											...
											<li><a><i class="fa fa-home"></i><font
												...
												<ul class="nav child_menu">
													<li><a href="/PCM/Comunes/Index.jsp">Index</a></li>
												</ul></li>
										</c:if>
							...
							<div class="sidebar-footer hidden-small">
								...
								<a data-toggle="tooltip" data-placement="top" title=""
									href="/PCM/Comunes/Login.jsp" data-original-title="Logout">
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								<div class="dropdown-menu dropdown-usermenu pull-right"
									...
									<a class="dropdown-item" href="/PCM/usuario?op=Cuenta">Perfil</a>
									<a class="dropdown-item" href="/PCM/Comunes/Login.jsp">Salir</a>
								</div>
							</li>
						</ul>
					</nav>
