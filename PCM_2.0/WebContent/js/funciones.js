...
function redireccionar() {
	...
	location.href = "/PCM/usuario?op=Salir";
}
	...
	if (contrasenna.length >= 8) {
		...
		if (mayuscula == true && minuscula == true && caracter_raro == true && numero == true) {
			...
			if (pass1 != pass2) {
				...
				var usuario = document.getElementById("nombre_confirmacion").value;
				var passViejo = document.getElementById("pass_confirmacion").value;
				var user = document.getElementById("nombre_confirmacion").value;
				var passNuevo = pass1;
				...
				$.ajax({
					...
					success: function(res) {
						if (res == "true") {
							...
							document.getElementById("id_permiso").value = "";
							document.getElementById("encriptacion").value = "";
							location.href = "/PCM/usuario?op=Listar&pagina=1";
...
/*function getMaterialBuscador(idinput, ida) {
	...
	if(material != "")
	{
		var aux1 = "/PCM/producto?op=busqueda&pagina=" + (paginaINT + 1) + "&buscador=" + material;
		var aux2 = "/PCM/producto?op=busqueda&pagina=" + (paginaINT - 1) + "&buscador=" + material;
	}else
	{
		var aux1 = "/PCM/producto?op=busqueda&pagina=" + (paginaINT + 1) + "&buscador=";
		var aux2 = "/PCM/producto?op=busqueda&pagina=" + (paginaINT - 1) + "&buscador=";
	...
	location.href = "/PCM/producto?op=busqueda&pagina=1&buscador=" + material;
}*/
...
function buscadorAdminMat(idinput, ida) {
	...
	var aux1 = "/PCM/producto?op=buscadorAdminMat&pagina=" + (paginaINT + 1) + "&buscador=" + material;
	var aux2 = "/PCM/producto?op=buscadorAdminMat&pagina=" + (paginaINT - 1) + "&buscador=" + material;
	...
	location.href = "/PCM/producto?op=buscadorAdminMat&pagina=1&buscador=" + material;
}
...
function limpiar() {
	...
	localStorage['pagina'] = "1";
	isSearch = false;
	location.href = "/PCM/producto?op=Listar&pagina=1";
}
...
function limpiarMat() {
	...
	localStorage['pagina'] = "1";
	isSearch = false;
	location.href = "/PCM/producto?op=AdministrarMateriales&pagina=1";
}
...
function previewNext(pagina) {
	...
	{
		//caso normal
		var next_normal = "/PCM/producto?op=Listar&pagina=" + (parseInt(pagina) + 1) + "&selectFiltro=" + filtro;
		var previous_normal = "/PCM/producto?op=Listar&pagina=" + (parseInt(pagina) - 1) + "&selectFiltro=" + filtro;
	...
	if (pag == "2") //si tiene filtro
	{
		...
		var next_especial = "/PCM/producto?op=busquedaEstatus&pagina=" + (parseInt(pagina) + 1) + "&selectFiltro=" + filtro;
		var previous_especial = "/PCM/producto?op=busquedaEstatus&pagina=" + (parseInt(pagina) - 1) + "&selectFiltro=" + filtro;
	...
	{
		//caso idmaterila
		var next_mat = "/PCM/producto?op=busqueda&pagina=" + (parseInt(pagina) + 1) + "&buscador=" + idMaterial + "&tipo=" + tipo;
		var previous_mat = "/PCM/producto?op=busqueda&pagina=" + (parseInt(pagina) - 1) + "&buscador=" + idMaterial + "&tipo=" + tipo;
...
function previewNextAdmin(pagina) {
	...
	{
		//caso normal
		var next_normal = "/PCM/producto?op=AdministrarMateriales&pagina=" + (parseInt(pagina) + 1) + "&selectFiltroAdmin=" + filtro;
		var previous_normal = "/PCM/producto?op=AdministrarMateriales&pagina=" + (parseInt(pagina) - 1) + "&selectFiltroAdmin=" + filtro;
	...
	{
		//caso rechazado/pendiente/aceptado
		var next_especial = "/PCM/producto?op=ESTATUS&pagina=" + (parseInt(pagina) + 1) + "&selectFiltroAdmin=" + filtro;
		var previous_especial = "/PCM/producto?op=ESTATUS&pagina=" + (parseInt(pagina) - 1) + "&selectFiltroAdmin=" + filtro;
	...
	{
		//caso idmaterila
		var next_mat = "/PCM/producto?op=BUSQUEDA&pagina=" + (parseInt(pagina) + 1) + "&buscador=" + idMaterial;
		var previous_mat = "/PCM/producto?op=BUSQUEDA&pagina=" + (parseInt(pagina) - 1) + "&buscador=" + idMaterial;
...
function getUsuarioBuscador(idinput, ida, servlet) {
	...
	var aux1 = "/PCM/" + servlet + "?op=busqueda&pagina=" + (paginaINT + 1) + "&buscador=" + aux;
	var aux2 = "/PCM/" + servlet + "?op=busqueda&pagina=" + (paginaINT - 1) + "&buscador=" + aux;
	...
	location.href = "/PCM/" + servlet + "?op=busqueda&pagina=1&buscador=" + aux;
}
...
function buscarIdMaterial(idmaterial) {
	...
	//location.href = "/PCM/producto?op=busqueda&pagina=" + (1) + "&buscador=" + id;
	location.href = "/PCM/producto?op=busqueda&pagina=" + (1) + "&buscador=" + id + "&tipo=" + tipo;
}
...
function buscarIdMaterialImg(idmaterial) {
	...
	//location.href = "/PCM/producto?op=busqueda&pagina=" + (1) + "&buscador=" + id;
	location.href = "/PCM/producto?op=busquedaImg&pagina=" + (1) + "&buscador=" + id + "&tipo=" + tipo;
}
...
function opcionBusquedaImg() {
	...
	if (tipo == '0') {
		location.href = "/PCM/producto?op=AdministrarImg&pagina=1";
...
/*function limpiarBusqueda(servlet) {
	...
	localStorage['pagina'] = "1";
	isSearch = false;
	location.href = "/PCM/" + servlet + "?op=Listar&pagina=1";
}*/
...
function isSearchingUsuario(paginaIN) {
	...
	if (search == "true") {
		var aux1 = "/PCM/usuario?op=busquedaA&pagina=" + (paginaINT + 1) + "&buscador=" + usuario;
		var aux2 = "/PCM/usuario?op=busqueda&pagina=" + (paginaINT - 1) + "&buscador=" + usuario;
...
//			location.href = "/PCM/producto?op=ELIMINAR&numero_material=" + numero_material + "&numero_imagen=" + numero_imagen;
			...
			Swal
				...
				.then(resultado => {
					if (resultado.value) {
						...
						//location.href =  "/PCM/producto?op=actualizarEstatus";
						document.getElementById('idCambioEstatus').submit();
			...
			success: function(res) {
				...
				if (respuestaOk == "OK") {
					...
					Swal.fire({
						...
						if (result.isConfirmed) {
							//location.href = "/PCM/producto?op=Listar&pagina=1";
							location.href = "/PCM/producto?op=RedireccionaCargaMasiva";
				...
				if (respuestaOk == "OK") {
					...
					Swal.fire({
						...
						if (result.isConfirmed) {
							...
							//location.href = "/PCM/Comunes/RegistroMasivo.jsp";
							location.href = "/PCM/producto?op=RedireccionaCargaMasiva";
...
function descargaImg() { //Funcion para saber que debo descargar
	...
	/*	if (descarga == "0") { //todas las img
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					//Redirecciono
					//location.href = "/PCM/producto?op=prueba";
					descargaImgAll();
				} else if (result.isDenied) {
					//No hago nada
				}
		...
		if (result.isConfirmed) {
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					location.href = "/PCM/producto?op=activarMaterial&tipo=Admin&materialesActivados=" + idmaterial;
				} else if (result.isDenied) {
				}
			})
		} else if (result.isDenied) {
...
function timer() {
	...
	setTimeout(function() { window.location.href = "http://172.16.0.5:8080"; }, 2000);
